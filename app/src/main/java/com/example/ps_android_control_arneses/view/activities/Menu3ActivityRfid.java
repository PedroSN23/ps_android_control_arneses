...
public class Menu3ActivityRfid extends RFIDControllActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.menu3_activity_rfid);
        ...
        cantidadTotal = findViewById(R.id.menu3CantLecturasRfid);
                ...
                if(epcs != null) {
                    for (int i = 0; i < epcs.size(); ++i) {
                        ...
                        if (!found) {
                            ...
                            tagsReadArr.add(0, new TagsRead(epcs.get(i), rsssDouble));
                        }
                    }
                }

                tagsReadArr.sort((tagsRead, t1) -> tagsRead.compareTo(t1.getcount()));
    ...
    public class MySimpleArrayAdapter extends ArrayAdapter<TagsRead> {
        ...
        MySimpleArrayAdapter(Context context, ArrayList<TagsRead> tagsRead) {
            super(context, R.layout.simple_list_item, tagsRead);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(rowView == null) {
                ...
                viewHolder.countText = rowView.findViewById(R.id.countText);
                viewHolder.rssiText = rowView.findViewById(R.id.rssiText);
            ...
            viewHolder.countText.setText(String.format(Locale.getDefault(), "%d", tagsRead.get(position).getcount()));
            viewHolder.rssiText.setText(String.format(Locale.getDefault(), "%.1f", tagsRead.get(position).getRssi()));
            return rowView;
        }
    }
